...
CREATE ROLE sri;
ALTER ROLE sri WITH SUPERUSER INHERIT NOCREATEROLE NOCREATEDB LOGIN NOREPLICATION NOBYPASSRLS PASSWORD 'SCRAM-SHA-256$4096:VpJ8McJd+P4GaBcgpbfSaQ==$9rjxjsProT15BbdImdWh+arLUxvbFpi3G6xu3kW2//A=:aVx+blGeCg/sB+V6YSxC5p3cDYiEGLd2ZU93PSIpkOA=';
...
--
-- Name: gspaces; Type: DATABASE; Schema: -; Owner: postgres
--

CREATE DATABASE gspaces WITH TEMPLATE = template0 ENCODING = 'UTF8' LOCALE_PROVIDER = libc LOCALE = 'C.UTF-8';


ALTER DATABASE gspaces OWNER TO postgres;
...
ALTER VIEW public.active_deals_view OWNER TO postgres;
...
ALTER SEQUENCE public.category_discounts_id_seq OWNER TO postgres;
...
CREATE TABLE public.coupon_usage (
    ...
    CONSTRAINT coupon_usage_usage_type_check CHECK (((usage_type)::text = ANY ((ARRAY['order'::character varying, 'wallet'::character varying])::text[])))
);
...
CREATE TABLE public.coupons (
    ...
    CONSTRAINT coupons_coupon_type_check CHECK (((coupon_type)::text = ANY ((ARRAY['order'::character varying, 'wallet'::character varying, 'both'::character varying])::text[]))),
    ...
    CONSTRAINT coupons_expiry_type_check CHECK (((expiry_type)::text = ANY ((ARRAY['expiry'::character varying, 'non_expiry'::character varying])::text[])))
);
...
ALTER SEQUENCE public.deal_campaigns_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.global_discount_id_seq OWNER TO postgres;
...
ALTER SEQUENCE public.room_visualizations_id_seq OWNER TO postgres;
...
ALTER VIEW public.visualization_stats OWNER TO postgres;
...
14	chityala srikanth	srichityala501@gmail.com		Hyderabad	7075077384	img/profiles/user_14_1775881216.png		Hyderabad	Telangana	500051	India					3500.00	10000.00	CHITYA14	\N	t	f
34	sreekanth	sri.chityala500@gmail.com	998969	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	1500.00	10000.00	SREEKA34	\N	t	f
...
35	sreekanth chityala	sri.chityala502@gmail.com	oauth_user_no_password_fhCA9OVQgZFJdhS9	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	1500.00	10000.00	SREEKA35	\N	t	f
36	Home	sri.chityala504@gmail.com	oauth_user_no_password_uiBxRi1Ctkwu1A1n	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	500.00	10000.00	HOME36	\N	t	f
