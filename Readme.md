...
sudo pip3 install certbot certbot-nginx pymysql flask_mail authlib google-auth google-auth-oauthlib google-auth-httplib2 flask psycopg2-binary markdown
